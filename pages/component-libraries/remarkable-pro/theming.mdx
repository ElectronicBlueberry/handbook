...
- You can pass **dynamic values** via  to your theme at run-time via **Client Context** (e.g. client-specific colors, or the name of a theme to apply), as well as create presets for testing in the builder. [Learn more here](/development/client-context).
