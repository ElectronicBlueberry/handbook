...
With these components excluded, you can copy your components over to the new folder and they’ll work in Embeddable as expected. Note: these components will _not_ be using themes … yet. You can adjust them to do so. [See **Using Themes** for full details](theming).

**2. Rename Your Components**

This allows you to retain every single packaged Vanilla chart _and_ use your charts as well, but it comes with a serious complication.
...
2. Your custom components will _not_ be using themes … yet. You can adjust them to do so. [See **Using Themes** for full details](theming).
