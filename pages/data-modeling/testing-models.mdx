...
<VideoComponent src="/video/data-playground.mp4" width="1250" height="854" />
...
<Callout emoji="💡">
  If your models are in a [separate repo](/data-modeling/getting-setup#2-storing-models-separately)
  to your components then, when running `embeddable:dev`, you'll have access to the components
  available in your online workspace.
</Callout>
...
<Callout emoji="">
  This relies on you having [Docker](https://www.docker.com/products/docker-desktop/) installed on
  your local machine.
</Callout>
