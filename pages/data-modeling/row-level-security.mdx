...
```html
<em-beddable token="eyJhbGciOiJIUzI..." />
```
...
- When requesting this security token, you also send a **security context**. This is simply a **JSON object** containing _any fields_ you need to pass to your data models:
