...
To start using the data model editor simply make sure that you've [set up your workspace](/getting-started/quick-start#setting-up-the-boilerplate) and then head to the **Data Model Editor** tab:
...
For a reference setup, take a look at our [starter repo](/getting-started/quick-start#getting-the-code). It demonstrates a typical way to organize your files. 
