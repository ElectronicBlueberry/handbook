...
- **SQL asks**: _“How do I compute this number right now?”_
- **Modeling asks**: _“What entities and metrics should always be available so my team, users, or customers can compute this (and related) numbers later, consistently?”_

<Callout emoji="💡">
  You can jumpstart modeling by clicking the **Ask AI** button (in the bottom right) and pasting in
  your SQL queries.
</Callout>
