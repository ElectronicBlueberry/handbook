...
<Callout emoji="💡">
  Best practice: keep your controls in the standard section of your dashboard, rather than in the
  Custom Canvas area. We don't recommend adding controls as templates to the Custom Canvas template
  library, as they will not necessarily work correctly (and may lead to a confusing user
  experience).
</Callout>
