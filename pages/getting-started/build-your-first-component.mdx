...
1. Inside `src/embeddable.com` in your [repo](/getting-started/quick-start#setting-up-the-boilerplate), create a folder called `components`.
...
<Callout emoji="🚀">**Success!** Your component is ready to try out.</Callout>
...
1. Create a new dashboard, or open the one you made in the [previous step](/getting-started/create-a-dashboard).
...
Any changes you make to your **components** or **data models** while developing locally and running `embeddable:dev` cause the workspace to refresh and instantly show you the effect of those changes 🚀.
...
<Callout emoji="💡">
  Learn more about [defining components](/development/defining-components),
  [loading data](/development/loading-data) and [adding
  interactivity](/development/interactivity).
</Callout>
