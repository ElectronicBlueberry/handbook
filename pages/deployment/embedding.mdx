...
```html
<script type="module" src="https://embed.embeddable.com/js/v1/?region=<region>"></script>
```
...
```html
<em-beddable token="eyJhbGciOiJIUzI1NiJ9..."></em-beddable>
```
...
<html>
  ...
  <body>
    <em-beddable token="eyJhbGciOiJI..."></em-beddable>
  </body>
</html>
```
...
export default function DashboardPage() {
  return (
    <>
      <script type="module" src="https://embed.embeddable.com/js/v1/?region=<region>" />
