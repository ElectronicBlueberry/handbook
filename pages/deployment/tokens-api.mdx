...
fetch('https://api.<region>.embeddable.com/api/v1/security-token', {
  ...
  body: JSON.stringify({
    ...
    securityContext: {
      // any context (key-value pairs) you want to provide to the SQL data models
